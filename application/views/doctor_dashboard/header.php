...
<head>
        ...
        <!-- Fontawesome CSS -->
        <link rel="stylesheet" href="<?php echo base_url();?>Template/assets/plugins/fontawesome/css/fontawesome.min.css">
        <link rel="stylesheet" href="<?php echo base_url();?>Template/assets/plugins/fontawesome/css/all.min.css">
