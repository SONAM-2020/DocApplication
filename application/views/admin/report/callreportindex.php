...
<section class="content-header">
  <h1>
   Generate Call Complaint Report
  </h1>
</section>
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <div class="box box-primary">
        <?php echo form_open('#' , array('class' => 'edit-profile m-b30', 'enctype' => 'multipart/form-data','id'=>'form'));?>
            <div class="box-body">
                <div class="card-body">
                    <div class="row">
...
<script>
  function submitForm(){
      ...
      var url='<?php echo base_url();?>index.php?adminController/loadpage/GenerateCallReport/';
      var options = {target: '#mainContentdiv',url:url,type:'POST',data: $("#form").serialize()}; 
