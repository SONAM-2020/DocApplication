...
<div class="wrapper">
  <header class="main-header">
    <a href="<?php echo base_url();?>index.php?adminController/dashboard" class="logo">
      <span class="logo-lg"><b>BTSS | SCHEDULER</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url();?>/uploads/logo/logo.png" onerror="this.src='<?php echo base_url();?>uploads/user1-128x128.jpg'" class="user-image" alt="User Image">
